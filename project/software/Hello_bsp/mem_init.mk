...
# Memory: bufferram_out
MEM_0 := SYSTEM_bufferram_out
$(MEM_0)_NAME := bufferram_out
...
$(MEM_0)_END := 0x1022edff
$(MEM_0)_SPAN := 0x0002ee00
$(MEM_0)_HIERARCHICAL_PATH := bufferram_out
$(MEM_0)_WIDTH := 16
...
.PHONY: bufferram_out
bufferram_out: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
