...
module SYSTEM_mm_interconnect_0 (
	...
	wire   [87:0] bufferram_out_s1_agent_rf_source_data;                                              // bufferram_out_s1_agent:rf_source_data -> bufferram_out_s1_agent_rsp_fifo:in_data
	...
	wire   [87:0] bufferram_out_s1_agent_rsp_fifo_out_data;                                           // bufferram_out_s1_agent_rsp_fifo:out_data -> bufferram_out_s1_agent:rf_sink_data
	...
	wire   [86:0] bufferram_out_s1_agent_rp_data;                                                     // bufferram_out_s1_agent:rp_data -> router_006:sink_data
	...
	wire   [86:0] bufferram_out_s1_burst_adapter_source0_data;                                        // bufferram_out_s1_burst_adapter:source0_data -> bufferram_out_s1_agent:cp_data
	...
	wire    [5:0] bufferram_out_s1_burst_adapter_source0_channel;                                     // bufferram_out_s1_burst_adapter:source0_channel -> bufferram_out_s1_agent:cp_channel
	...
	wire   [86:0] router_006_src_data;                                                                // router_006:src_data -> bufferram_out_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                               // bufferram_out_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [5:0] router_006_src_channel;                                                             // router_006:src_channel -> bufferram_out_s1_rsp_width_adapter:in_channel
	...
	wire  [104:0] bufferram_out_s1_rsp_width_adapter_src_data;                                        // bufferram_out_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          bufferram_out_s1_rsp_width_adapter_src_ready;                                       // rsp_demux_004:sink_ready -> bufferram_out_s1_rsp_width_adapter:out_ready
	wire    [5:0] bufferram_out_s1_rsp_width_adapter_src_channel;                                     // bufferram_out_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [104:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> bufferram_out_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                              // bufferram_out_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> bufferram_out_s1_cmd_width_adapter:in_channel
	...
	wire   [86:0] bufferram_out_s1_cmd_width_adapter_src_data;                                        // bufferram_out_s1_cmd_width_adapter:out_data -> bufferram_out_s1_burst_adapter:sink0_data
	...
	wire    [5:0] bufferram_out_s1_cmd_width_adapter_src_channel;                                     // bufferram_out_s1_cmd_width_adapter:out_channel -> bufferram_out_s1_burst_adapter:sink0_channel
